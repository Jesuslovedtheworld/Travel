...
public class LookAllRlvAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private ArrayList<LookAllBean.ResultBean.ReviewsBean> mArr;
    private Context context;
    private int type;

    public LookAllRlvAdapter(ArrayList<LookAllBean.ResultBean.ReviewsBean> mArr, Context context) {
        this.mArr = mArr;
        this.context = context;
    }

    public void setmArr(ArrayList<LookAllBean.ResultBean.ReviewsBean> mArr) {
        this.mArr = mArr;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (viewHolder instanceof VH){
            VH vh = (VH) viewHolder;
            LookAllBean.ResultBean.ReviewsBean reviewsBean = mArr.get(i);
            final String  img = (String) reviewsBean.getUserPhoto();
